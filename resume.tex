...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		...
		Python:  & {\qquad\skill{Программирую и анализирую данные с помощью pandas, numpy, scipy (библиотеки алгоритмов}} \\
...
\begin{cventries}
	\cventry
		{}
	{Прошла курс "Математика и Python для анализа данных" в организации Coursera:
	...
	\cventry
		{}
	{Прошла курс Bloomberg Market Concepts и получила соответствующий сертификат}
	{}
	{}
	{}
	\end{cventries} \vspace{-6mm} \begin{cventries}
