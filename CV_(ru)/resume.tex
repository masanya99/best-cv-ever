...
\usepackage{tikz}
\geometry{left=1cm, top=1cm, right=1.0cm, bottom=0.5cm, footskip=.3cm}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		...
		Python:  & {\qquad\skill{Программирую и анализирую данные с помощью pandas,  numpy,  dask,  nltk,  scipy,  seaborn,  sklearn}} \\
		   & {\qquad\skill{(библиотеки алгоритмов для анализа, моделирования и обработки данных, многомерных массивов, }} \\
		   & {\qquad\skill{а также библиотеки машинного обучения и прогноза данных)}} \\
